...
const PROJECTS = [
  ...
  },
  {
    ...
    status: "Production",
    summary:
      "Interactive analytics dashboard processing multi-source data streams. Provides real-time insights for executive decision-making with 50+ KPI visualizations.",
    description:
      "Executive dashboard aggregating data from multiple business systems to provide real-time insights. Features custom visualizations, automated reporting, and predictive analytics for strategic planning.",
